...
const AP4_Atom::Type AP4_ATOM_TYPE_RMRA = AP4_ATOM_TYPE('r','m','r','a');
const AP4_Atom::Type AP4_ATOM_TYPE_RMDA = AP4_ATOM_TYPE('r','m','d','a');
const AP4_Atom::Type AP4_ATOM_TYPE_RDRF = AP4_ATOM_TYPE('r','d','r','f');

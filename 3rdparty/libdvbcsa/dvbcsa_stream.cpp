...
DVBCSA_INLINE
static uint8_t swap_nbl (register uint8_t byte)
{
...
DVBCSA_INLINE
static uint8_t csa_stream_rotate (register uint32_t pqzyx,
					 register uint32_t x)
{
...
DVBCSA_INLINE
static uint32_t csa_stream_sboxes(register uint64_t A)
{
...
DVBCSA_INLINE
static uint32_t csa_stream_B_sel	(register uint64_t B)
{
  uint32_t	t = B >> 9;
...
DVBCSA_INLINE
static uint32_t csa_stream_cfed (uint32_t pqzyx, uint32_t cfed)
{
...
static void csa_stream_init_round(uint32_t iv,

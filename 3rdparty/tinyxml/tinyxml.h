...
public:
	...
	__int64			Int64Value() const;									///< Return the value of this attribute, converted to an __int64.
	...
	*/
	...
	int QueryInt64Value( __int64* _value ) const;
	int QueryHexValue( unsigned int* _value ) const;

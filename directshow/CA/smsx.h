...
typedef struct   
{ 
	U32						uCardNumber;/*崘嬬触催*/ 
    U8					    uCardUA[9];/*崘嬬触ID・祥頁触頭貧中・幣議匯堪方*/ 
	U8						iAgeGrade; /*定槍吉雫*/ 
 
}Smsx_Info_t; 
 
Smsx_Info_t  smsx;/*畠蕉延楚・壓崘嬬触兜兵晒朔辛參岷俊聞喘万議匯乂佚連阻*/ 
...
bool smsx_parse_ecm(Smart_Handle_t Handle,U8* pbuf,U8* pucCW); 
...
bool smsx_parse_emm(Smart_Handle_t Handle,U8* pbuf,U16 len);//盾裂EMM・頼撹娩幡吉 

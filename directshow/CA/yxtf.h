...
{ 
	...
	U8             paringflag;              /*塘斤炎紛 0-崘嬬触隆才販採字競歳塘斤 1-崘嬬触才字競歳塘斤狛*/ 
}Yxtf_Info_t; 
 
Yxtf_Info_t  yxtf; /*畠蕉延楚・壓崘嬬触兜兵晒朔辛參岷俊聞喘万議匯乂佚連阻*/ 
...
bool yxtf_pairing(Smart_Handle_t Handle, U8* pairingcode);//字触塘斤・嗤議仇圭俶勣頼撹宸倖強恬嘉嬬盾竃准朕 

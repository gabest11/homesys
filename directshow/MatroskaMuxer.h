...
{
	MatroskaWriter::TrackEntry* m_pTE;
	std::vector<MatroskaWriter::CBinary*> m_pVorbisHdrs;
...
public:
	...
	CCritSec m_csQueue;
	std::list<MatroskaWriter::BlockGroup*> m_blocks;
...
{
protected:
	std::vector<CMatroskaMuxerInputPin*> m_pInputs;
	CMatroskaMuxerOutputPin* m_pOutput;

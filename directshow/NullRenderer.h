...
public:
	CNullRenderer(const CLSID& clsid, TCHAR* pName, LPUNKNOWN pUnk, HRESULT* phr);
};
...
class CNullRawVideoRenderer : public CNullRenderer
{
protected:
	HRESULT CheckMediaType(const CMediaType* pmt);

public:
	CNullRawVideoRenderer(LPUNKNOWN pUnk, HRESULT* phr);
};
...
class CNullRawAudioRenderer : public CNullRenderer
{
protected:
	HRESULT CheckMediaType(const CMediaType* pmt);

public:
	CNullRawAudioRenderer(LPUNKNOWN pUnk, HRESULT* phr);
};
...
class CNullTextRenderer : public CBaseFilter, public CCritSec
{
	...
	CTextInputPin* m_pInput;

public:
	CNullTextRenderer(LPUNKNOWN pUnk, HRESULT* phr);
	virtual ~CNullTextRenderer();
